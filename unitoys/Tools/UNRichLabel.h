 ...
 */
typedef void (^KILinkTapHandler)(UNRichLabel *label, NSString *string, NSRange range);
 ...
 **/
IB_DESIGNABLE
@interface UNRichLabel : UILabel <NSLayoutManagerDelegate>
