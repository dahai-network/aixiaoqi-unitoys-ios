...
ST_PREREAD_FID PreReadFID_MC323[] = {  /*	MC323	*/
									{PREREAD_A4, {0x3f, 0x00}}, 
			 					   	{PREREAD_B0, {0x2f, 0xe2}},
								   	{PREREAD_B0, {0x2f, 0x05}},
								    ...
								    {PREREAD_B2, {0x6f, 0x4b}},
								   	{PREREAD_B2, {0x6f, 0x4c}},
								   	{PREREAD_B2, {0x6f, 0x49}},
								   	{PREREAD_C0, {0x7f, 0x25}}, 
                                    {PREREAD_B0, {0x6f, 0x57}},//imsi weikk
								   	{PREREAD_B0, {0x6f, 0x31}},
								   	{PREREAD_B0, {0x6f, 0x47}},
								   	{PREREAD_B2, {0x6f, 0x28}},
								   	{PREREAD_B0, {0x6f, 0x3a}},
								   	{PREREAD_B0, {0x6f, 0x22}},
									{PREREAD_B0, {0x6f, 0x23}},
									{PREREAD_B0, {0x6f, 0x24}},
								   	{PREREAD_B2, {0x6f, 0x21}},
								   	{PREREAD_B0, {0x6f, 0x2c}},
								   	{PREREAD_B0, {0x6f, 0x39}},
									{PREREAD_B0, {0x6f, 0x32}},
									{PREREAD_B2, {0x6f, 0x29}},
									{PREREAD_B2, {0x6f, 0x3c}},
									{PREREAD_B0, {0x6f, 0x25}},
									{PREREAD_B0, {0x6f, 0x36}},
									//{PREREAD_B0, {0x6f, 0x30}},									 
									{PREREAD_B0, {0x6f, 0x45}},
									{PREREAD_B0, {0x6f, 0x46}},
									{PREREAD_B0, {0x6f, 0x34}},
									{PREREAD_B0, {0x6f, 0x35}},
									{PREREAD_B2, {0x6f, 0x44}},
									{PREREAD_B0, {0x6f, 0x2d}},
									{PREREAD_B0, {0x6f, 0x3e}},
									{PREREAD_B0, {0x6f, 0x5b}},
									{PREREAD_B0, {0x6f, 0x5c}},
									{PREREAD_B2, {0x6f, 0x5d}},
									{PREREAD_B2, {0x6f, 0x5e}},
									//{PREREAD_B0, {0x6f, 0x42}},
										
									{PREREAD_B0, {0x6f, 0x2a}},
									{PREREAD_B0, {0x6f, 0x2b}},

								   	{PREREAD_C0, {0x7f, 0x21}},
									{PREREAD_END, {0xff, 0xff}}
									};
...
_INT32 SPPreRd_Read_SIM(_UINT32 ChannelId, _UINT32 uiBuffLeftLen)
{
		...
		if(pChnStHandle->uiPreRdExpLen == uiBuffLeftLen)
		{
			...
			if(PreReadFID[pChnStHandle->uiPreRdIdx].type != PREREAD_C0)
			{
				...
				if(PreReadFID[pChnStHandle->uiPreRdIdx].type == PREREAD_B0)
				{
					...
					if(1)//(NVM_GOIP_SIMTYPE_GSM == uiSimType)//only for m35
					{
	...
	else if(SPPRERD_SUBST_B0RSPWAIT == pChnStHandle->SPPreRDStatus)
	{
        if(pChnStHandle->uiPreRdExpLen == uiBuffLeftLen)
		{
            ...
            //wkk 20170106
            if(pChnStHandle->simCardType == EN_SIMTYPE_CTCC)
            {
                if((0x6f == pPreRdFileId->FileID[0]) && (0x57 == pPreRdFileId->FileID[1]))
    			{
    				memset(pChnStHandle->IMSIBuf, 0, sizeof(pChnStHandle->IMSIBuf));
                    memcpy(pChnStHandle->IMSIBuf, &pPreRdCmdElmt->RspData[3], 15);
                    SIMCOM_INFO("Channel %d IMSI:%s\n", ChannelId, pChnStHandle->IMSIBuf);
    			}
            }
