...
#define SIMPOOL_RSPREAD_MAX_SIZE    1024
...
typedef enum
{
    EN_TIMER_CALLID_NONE = 100,
    EN_TIMER_CALLID_SETSIMTPYE,
	EN_TIMER_CALLID_DETSIMIN,
	EN_TIMER_CALLID_RST,
...
{    
    ...
    EN_SIMTYPE simCardType;

    EOS_TIMER_ID    SetSimTypeTimerId;
